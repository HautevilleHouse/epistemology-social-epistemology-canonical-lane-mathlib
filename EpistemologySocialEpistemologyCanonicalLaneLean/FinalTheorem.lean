import EpicenterSocialEpistemologyCanonicalLaneLean.GateLemmas
...
theorem constrained_social_epistemology_endgame (A : AdmissibleClass) :
    ConstrainedSocialEpistemologyClosure A := by
